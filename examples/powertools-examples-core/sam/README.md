...
```bash
sam$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
sam$ sam logs -n HelloWorldFunction --stack-name sam --tail
```
