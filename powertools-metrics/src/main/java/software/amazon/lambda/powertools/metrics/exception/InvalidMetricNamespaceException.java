...
public class InvalidMetricNamespaceException extends RuntimeException {
    ...
    public InvalidMetricNamespaceException() {
        super(POWERTOOLS_METRICS_NAMESPACE_REQUIRED);
    }

    public InvalidMetricNamespaceException(Throwable e) {
        super(POWERTOOLS_METRICS_NAMESPACE_REQUIRED, e);
    }
}
