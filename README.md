...
Now you can configure your log4j2.xml file to include the custom layout *LambdaJsonLayout*
```xml
...
This library is licensed under the Apache License, Version 2.0 License. See the LICENSE file.
