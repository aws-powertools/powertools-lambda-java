...
/**
 * Exception thrown only when using {@link
 * software.amazon.lambda.powertools.idempotency.IdempotencyConfig#throwOnNoIdempotencyKey()}, and
 * if a key could not be found in the event (for example when having a bad JMESPath configured)
 */
