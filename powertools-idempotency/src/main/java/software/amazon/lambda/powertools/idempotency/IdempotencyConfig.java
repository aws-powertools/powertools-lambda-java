...
public class IdempotencyConfig {
    ...
    private IdempotencyConfig(
            ...
            boolean throwOnNoIdempotencyKey,
    ...
    public static class Builder {
         ...
         *
         * <ul>
         *   <li><code>powertools_json(body)</code> for APIGatewayProxyRequestEvent and
         *       APIGatewayV2HTTPEvent
         *   <li><code>Records[*].powertools_json(body)</code> for SQSEvent
         *   <li><code>Records[0].Sns.Message | powertools_json(@)</code> for SNSEvent
         *   <li><code>detail</code> for ScheduledEvent (EventBridge / CloudWatch events)
         *   <li><code>Records[*].kinesis.powertools_json(powertools_base64(data))</code> for
         *       KinesisEvent
         *   <li><code>Records[*].powertools_json(powertools_base64(data))</code> for
        ...
        /**
         * Whether to throw an exception if no idempotency key was found in the request, by default
         * false
         *
        ...
        /**
         * Throw an exception if no idempotency key was found in the request. Shortcut for {@link
         * #withThrowOnNoIdempotencyKey(boolean)}, forced as true
         *
         * @return the instance of the builder (to chain operations)
         */
