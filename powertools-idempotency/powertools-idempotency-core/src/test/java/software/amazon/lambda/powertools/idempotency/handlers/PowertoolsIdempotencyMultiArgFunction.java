...
/**
 * Lambda function using PowertoolsIdempotency with explicit idempotency key
 */
public class PowertoolsIdempotencyMultiArgFunction implements RequestHandler<Product, Basket> {
