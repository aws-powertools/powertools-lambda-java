...
=== "Gradle"
    ...
    dependencies {
        implementation 'software.amazon.lambda:powertools-tracing:1.7.0'
        aspectpath 'software.amazon.lambda:powertools-tracing:1.7.0'
        implementation 'software.amazon.lambda:powertools-logging:1.7.0'
        aspectpath 'software.amazon.lambda:powertools-logging:1.7.0'
        implementation 'software.amazon.lambda:powertools-metrics:1.7.0'
        aspectpath 'software.amazon.lambda:powertools-metrics:1.7.0'
    }
    ```
    **Note:**
