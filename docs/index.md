...
=== "Gradle"
    ...
    dependencies {
        ...
        aspectpath 'software.amazon.lambda:powertools-tracing:1.7.2'
        implementation 'software.amazon.lambda:powertools-logging:1.7.2'
        aspectpath 'software.amazon.lambda:powertools-logging:1.7.2'
        implementation 'software.amazon.lambda:powertools-metrics:1.7.2'
        aspectpath 'software.amazon.lambda:powertools-metrics:1.7.2'
    }
    ```
    **Note:**
