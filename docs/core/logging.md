...
Prior to version [1.10.2](https://github.com/awslabs/aws-lambda-powertools-java/releases/tag/v1.10.2), only supported way of configuring `log4j2.xml` was via  `<LambdaJsonLayout/>`. This plugin is 
