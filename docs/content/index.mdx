...
dependencies {
    implementation 'software.amazon.lambda:powertools-tracing:1.0.1'
    aspectpath 'software.amazon.lambda:powertools-tracing:1.0.1'
    implementation 'software.amazon.lambda:powertools-logging:1.0.1'
    aspectpath 'software.amazon.lambda:powertools-logging:1.0.1'
    implementation 'software.amazon.lambda:powertools-metrics:1.0.1'
    aspectpath 'software.amazon.lambda:powertools-metrics:1.0.1'
}
```
