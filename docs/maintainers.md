...
description: Playbook for active maintainers in Powertools for AWS Lambda (Java)
---
...
| Michele Ricciardi     | [rubenfonseca](https://github.com/mriccia){target="_blank" rel="nofollow"}          | Amazon      |
| Scott Gerring         | [leandrodamascena](https://github.com/scottgerring){target="_blank" rel="nofollow"} | Amazon      |
...
Visit the [Releases page](https://github.com/aws-powertools/powertools-lambda-java/releases) and choose the edit pencil button.
...
See [Roadmap section](https://docs.powertools.aws.dev/lambda/java/latest/roadmap/)
